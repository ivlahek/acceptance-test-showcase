...
public class UserAccountControllerTest extends RestIntegrationTest {
    ...
    public void should_create_user_account() {
        ...
        //OPERATE
        ResponseEntity<UserAccountDTO> responseEntity = restTemplate.postForEntity(UserAccountEndpoints.USER_RESOURCE, createUserAccountDTO, UserAccountDTO.class, organization.getId());
    ...
    public void should_get_user_account() {
        //OPERATE
        ResponseEntity<UserAccountDTO> responseEntity = restTemplate.getForEntity(UserAccountEndpoints.USER_RESOURCE_BY_ID, UserAccountDTO.class, organization.getId(), userAccount.getId());
