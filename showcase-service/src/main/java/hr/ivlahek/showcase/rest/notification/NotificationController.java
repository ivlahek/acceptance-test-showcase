...
public class NotificationController {
    ...
    public void sendNotification(@PathVariable("organizationId") int organizationId,
                                 @RequestBody SendNotificationRequest request) {
        logger.info(request.toString());

        Optional<MobileApplication> optionalMobileApplication = mobileApplicationRepository.findByIdAndOrganizationId(request.getMobileApplicationId(), organizationId);
